...
INSERT INTO
    `_prisma_migrations`
VALUES (
        'b40ed226-1fab-4b33-807d-b2928085e536',
        '3763961aa73dcfac5cf6f79c16a5f7e767b7b55290ce93fdd64f39c52122acc9',
        '2023-11-07 11:14:36.829',
        '0_init',
        NULL,
        NULL,
        '2023-11-07 11:14:34.805',
        1
    );
...
INSERT INTO `comfort`
VALUES (1, 'WiFi'), (2, 'TV'), (3, 'Air Conditioning');
...
INSERT INTO `comfortPlusHouse`
VALUES (1, 1, 3, 'true'), (2, 2, 1, 'true'), (3, 2, 2, 'true'), (4, 1, 2, 'true'), (5, 3, 3, 'false');
...
CREATE TABLE
    `hotel` (
        ...
        `contact_inf` varchar(50) DEFAULT NULL,
...
VALUES (
        ...
        'Hotel Description 4',
        'Contact Info 4',
        'https://images.unsplash.com/photo-1543321269-9d86d3680e1c?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        'Hotel Description 5',
        'Contact Info 5',
        'https://images.unsplash.com/photo-1562809896-1b1514f40708?auto=format&fit=crop&q=80&w=1781&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        'Hotel Description 6',
        'Contact Info 6',
        'https://images.unsplash.com/photo-1570107515092-7000ae2e6d1a?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        'Hotel Description 7',
        'Contact Info 7',
        'https://images.unsplash.com/photo-1572552719565-651d9a1bca94?q=80&w=1806&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        'Hotel Description 8',
        'Contact Info 8',
        'https://images.unsplash.com/photo-1599722585837-c1cb8eea32ff?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        'free',
        150,
        '{"main": "https://a0.muscache.com/im/pictures/miso/Hosting-679390800019898631/original/ac5ae2a8-d1fe-4c5e-8de1-b671a84b1dc9.jpeg",
        "other": ""}'
    ), (
        2,
        'Sample House 2',
        ...
        'free',
        120,
        '{"main": "https://a0.muscache.com/im/pictures/miso/Hosting-679390800019898631/original/80ac817f-bc11-4bbf-8f06-c7ee3d4eb539.jpeg",
        "other": ""}'
    ), (
        3,
        'Sample House 3',
        ...
        'occupied',
        200,
        '{"main": "https://a0.muscache.com/im/pictures/e658cbe8-80e0-48a3-b6a1-6d238c9f962c.jpg",
        "other": ""}'
    );
...
CREATE TABLE
    `housePhoto` (
        ...
        PRIMARY KEY (`id`),
        KEY `house_id` (`house_id`),
        CONSTRAINT `housePhoto_ibfk_1` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`) ON DELETE CASCADE
    ) ENGINE = InnoDB AUTO_INCREMENT = 4 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
-- Dumping data for table `housePhoto`

--

/*!40000 ALTER TABLE `housePhoto` DISABLE KEYS */

;

INSERT INTO `housePhoto`
VALUES (
        1,
        1,
...
/*!40000 ALTER TABLE `housePhoto` ENABLE KEYS */
...
VALUES (1, '2023-11-04', 100.50, 1), (2, '2023-11-05', 75.20, 2), (3, '2023-11-06', 150.75, 1);
...
CREATE TABLE
    `reservation` (
        ...
        `status` enum('active', 'denied', 'end') DEFAULT NULL,
        `sum` smallint unsigned DEFAULT NULL,
        PRIMARY KEY (`id`),
        KEY `user_id` (`user_id`),
...
CREATE TABLE
    `review` (
        ...
        CONSTRAINT `check_rate` CHECK ( (`rate` <= 5))
    ) ENGINE = InnoDB AUTO_INCREMENT = 4 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
VALUES (
        ...
        'Room Description 1',
        75,
        '{"main": "https://a0.muscache.com/im/pictures/e5f6a006-ed2c-46f7-81cc-b5f3d713d9c1.jpg",
        "other": ""}'
    ), (
        2,
        1,
        ...
        'Room Description 2',
        85,
        '{"main": "https://a0.muscache.com/im/pictures/1c14cee3-aa96-436a-a39a-7206291eb371.jpg", "other": ""}' 
    ), (
        3,
        2,
        3,
        ...
        'Room Description 3',
        95,
        '{"main": "https://a0.muscache.com/im/pictures/3ffecb5f-27b6-4519-9226-d125330d7bbb.jpg", "other": ""}' 
    );
...
CREATE TABLE
    `roomPhoto` (
        ...
        PRIMARY KEY (`id`),
        KEY `room_id` (`room_id`),
        CONSTRAINT `roomPhoto_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE
    ) ENGINE = InnoDB AUTO_INCREMENT = 4 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
/*!40000 ALTER TABLE `roomPhoto` DISABLE KEYS */

;

INSERT INTO `roomPhoto`
VALUES (
        1,
        1,
...
/*!40000 ALTER TABLE `roomPhoto` ENABLE KEYS */
...
-- Dump completed on 2023-11-07 16:49:46